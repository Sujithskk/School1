                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.loginAuthResponse =
                                        await LoginAuthCall.call(
                                      username:
                                          _model.emailAddressController.text,
                                      password: _model.passwordController.text,
                                    );
                                    if ((_model.loginAuthResponse?.succeeded ??
                                        true)) {
                                      context.pushNamed('testttt12');

                                      setState(() {
                                        FFAppState().username = getJsonField(
                                          (_model.loginAuthResponse?.jsonBody ??
                                              ''),
                                          r'''$.data.studentInfo.name''',
                                        ).toString();
                                        ...
                                        FFAppState().classSection =
                                          ...
                                          (_model.loginAuthResponse?.jsonBody ??
                                              ''),
                                          r'''$.data.studentInfo.class_section''',
                                        ).toString();
                                        FFAppState().dob = getJsonField(
                                          (_model.loginAuthResponse?.jsonBody ??
                                              ''),
                                          r'''$.data.studentInfo.dob''',
                                        ).toString();
                                        FFAppState().roll = getJsonField(
                                          (_model.loginAuthResponse?.jsonBody ??
                                              ''),
                                          r'''$.data.studentInfo.roll_number''',
                                        ).toString();
                                        FFAppState().profileurl = getJsonField(
                                          (_model.loginAuthResponse?.jsonBody ??
                                              ''),
                                          r'''$.data.studentInfo.profile_pic_url''',
                                        ).toString();
                                      });
                                    } else {
                      ...
                      child: Row(
                        ...
                        children: [
                          if (responsiveVisibility(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'hdlz2qix' /* © 2021 St. John's Public Schoo... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
