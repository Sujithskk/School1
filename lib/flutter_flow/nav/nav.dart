      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => Login1Widget(
            loginResponse: params.getParam('loginResponse', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'HomeWork',
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HomeWork')
        ...
        FFRoute(
          ...
          path: '/noticeBoard',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'NoticeBoard')
        ...
        FFRoute(
          ...
          path: '/writeToSchool',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'WriteToSchool')
              : const WriteToSchoolWidget(),
        ),
        FFRoute(
          name: 'FessHistory',
          path: '/fessHistory',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'FessHistory')
              : const FessHistoryWidget(),
        ),
        FFRoute(
          name: 'Upcomingevents',
          path: '/upcomingevents',
